...
```
`npm test` runs the forecast tests (`node --test`, no extra dependencies: engine parity with the Python golden fixture, stats, stock-out days, accuracy grading); there is no other test suite yet.
